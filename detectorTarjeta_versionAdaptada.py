...
areaAgujero = 1700 
rangoErrorArea = 1100
rangoErrorPinchazos = 35   

tarjetaCompletamenteInsertada = False
enDepuracion = True # Para activar los print, poner a False para hacer el programa mas rapido
...
while True:
	...
	if blobs:
		...
		tarjetaCompletamenteInsertada = np.all(blobs.length() <= longitudMaxAgujero)
	...
	if tarjetaCompletamenteInsertada and blobs:
		...
		print buscaAgujerosPinchados(arrayAlista(blobs.coordinates()))
	else:
